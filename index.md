...
<div class="hacker-page">
  ...
  <div class="hero-section">
    ...
    <div class="hero-text">
      ...
      <p class="bio">Transitioning from a 3rd-year IT Engineering student to a full-time breaker of things. Passionate about simulating the real-world cyber attacks, C2's, and continuous learning.</p>
...
<li class="timeline-item">
  ...
  <li class="timeline-item">
    <div class="timeline-date">2026 · Completed</div>
